...
const Signup = ({ API_URL = "http://localhost:4000", onSignup }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.55), rgba(15, 23, 42, 0.7)), url(${signupBg})`,
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className={signupStyles.grid}>
        {/* Left: FinSight AI branding - visible on lg+ */}
        <div className={signupStyles.brandPanel}>
          <div className={signupStyles.brandOverlay} aria-hidden="true" />
          <div className="relative z-10">
            <h2 className={signupStyles.brandLogo}>Smart Expense Tracker</h2>
            <p className={signupStyles.brandTagline}>
              Smarter spending, clearer goals. Track expenses and reach your financial targets with AI-powered insights.
            </p>
            <ul className={signupStyles.brandFeatures}>
              <li className={signupStyles.brandFeature}>
                <BarChart2 className={signupStyles.brandFeatureIcon} />
                Track income, expenses & budgets in one place
              </li>
              <li className={signupStyles.brandFeature}>
                <Shield className={signupStyles.brandFeatureIcon} />
                Secure and private — your data stays yours
              </li>
              <li className={signupStyles.brandFeature}>
                <Sparkles className={signupStyles.brandFeatureIcon} />
                Goals and insights to stay on track
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className={signupStyles.cardContainer}>
          <div className={signupStyles.formCard}>
            <div className={signupStyles.header}>
              ...
              <p className={signupStyles.headerSubtitle}>
                Join Smart Expense Tracker to manage your finances
              </p>
            </div>
            ...
            <div className={signupStyles.formContainer}>
              {errors.api && (
                <p className={signupStyles.apiError}>
                  <span className="font-medium">Error:</span> {errors.api}
                </p>
              )}
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                <div>
                  ...
                  <div className={signupStyles.inputContainer}>
                    ...
                    <input
                      ...
                      className={`${signupStyles.input} ${errors.name ? "border-red-400 focus:ring-red-500/30 focus:border-red-500" : ""}`}
                ...
                <div>
                  ...
                  <div className={signupStyles.inputContainer}>
                    ...
                    <input
                      ...
                      className={`${signupStyles.input} ${errors.email ? "border-red-400 focus:ring-red-500/30 focus:border-red-500" : ""}`}
                ...
                <div>
                  ...
                  <div className={signupStyles.inputContainer}>
                    ...
                    <input
                      ...
                      className={`${signupStyles.passwordInput} ${errors.password ? "border-red-400 focus:ring-red-500/30 focus:border-red-500" : ""}`}
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                >
                  {isLoading ? (
                    <>
                      <svg className={signupStyles.spinner} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
