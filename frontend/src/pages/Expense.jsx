...
const ExpensePage = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      let filename = `expense_${timeFrame}.xlsx`;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardsGrid}>
        <FinancialCard
          ...
          value={`${user?.currencySymbol || "$"}${totalExpense.toLocaleString()}`}
          additionalContent={
        ...
        <FinancialCard
          ...
          value={`${user?.currencySymbol || "$"}${averageExpense.toLocaleString()}`}
          additionalContent={
            <div className="mt-2 text-xs text-gray-500 flex items-center">
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis
                ...
                tick={{ fill: "#6b7280", fontSize: 12 }}
                width={60}
                tickFormatter={(value) => `${user?.currencySymbol || "$"}${value.toLocaleString()}`}
              />
              <Tooltip
                formatter={(value) => [
